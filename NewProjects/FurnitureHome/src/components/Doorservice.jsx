...
import doorImg from "../assets/images/door1.jpg"; // Replace with your door image

export default function DoorService() {
  const galleryImages = Array(8).fill({ src: doorImg, alt: "Door Design" });
    ...
    <section className="bg-stone-300 min-h-screen px-6 sm:px-10 py-20">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
          Enhance your home with stylish and secure doors. We specialize in custom designs,
          high-quality materials, and professional installation to give your doors both
        ...
        {[
          {
            ...
            desc: "We create doors tailored to your style and space, enhancing aesthetics and functionality.",
          },
          {
            title: "Durable Materials",
            desc: "High-quality wood, metal, and composite materials for long-lasting durability and elegance.",
          },
          {
            title: "Professional Installation",
            desc: "Expert installation with precision and attention to detail for perfect fit and security.",
          },
        ].map((item, index) => (
          <div
            key={index}
      ...
      <div className="text-center">
        ...
        <p className="text-gray-700 mb-8 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
          Contact us today to discuss your custom door project and get a free consultation.
        </p>
        <a
          href="/contact"
