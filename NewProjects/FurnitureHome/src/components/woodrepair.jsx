...
import woodImg from "../assets/images/woodcomponants.jpg"; // Replace with your wood repair image

export default function WoodRepair() {
  const galleryImages = Array(8).fill({ src: woodImg, alt: "Wood Repair Example" });
    ...
    <section className="bg-stone-300 min-h-screen px-6 sm:px-10 py-20">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
          Restore the beauty and functionality of your wooden furniture and structures.
          We specialize in repairs, refinishing, and custom restoration to bring your
        ...
        {[
          {
            ...
            desc: "Repair and restore wooden furniture to its original beauty and strength.",
          },
          {
            title: "Structural Wood Repair",
            desc: "Fix damaged wooden doors, frames, and panels with precision and durability.",
          },
          {
            title: "Custom Finishing",
            desc: "Refinish and polish wood surfaces to match your desired style and finish.",
          },
        ].map((item, index) => (
          <div
            key={index}
      ...
      <div className="text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">
          Ready to Restore Your Woodwork?
        </h2>
        <p className="text-gray-700 mb-8 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
          Contact us today to discuss your wood repair project and get a free consultation.
        </p>
        <a
          href="/contact"
